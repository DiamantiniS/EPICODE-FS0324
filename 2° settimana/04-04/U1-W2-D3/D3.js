...
console.log("Length of charactersNames before:", charactersNames.length);

for (let i = 0; i < femaleCharacters.length; i++) {
    const nameToRemove = femaleCharacters[i].name;
    const indexToRemove = charactersNames.indexOf(nameToRemove);
...
console.log("Length of charactersNames after:", charactersNames.length);
